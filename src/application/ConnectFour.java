...
public class ConnectFour extends Application {
	...
	public static void main(String[] args) {
		...
		try {
			/**
			 * since every character has a corresponding decimal value 0 to 9
			 * have corresponding int values from 48 to 57
			 */
			if ((args[0].trim().charAt(0) >= 48 && args[0].trim().charAt(0) <= 57)
					&& (args[1].trim().charAt(0) >= 48 && args[1].trim().charAt(0) <= 57)) {
